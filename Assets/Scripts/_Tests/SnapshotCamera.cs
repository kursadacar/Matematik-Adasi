        ...
        if (item != null)
        {
            switch (item.type)
            {
                ...
                case Item.ItemType.Fish:
                    {
                        item.transform.position = cam.transform.position + new Vector3(-0.37f, 0.2262046f, 2.57f);
                        item.transform.rotation = Quaternion.Euler(16.62f, 109.128f, 8.468f);
                        item.transform.localScale = new Vector3(35.72188f, 35.72188f, 35.72188f);
                    }
                    break;
                case Item.ItemType.Rod:
                    break;
                case Item.ItemType.Hat:
                    {
                        item.transform.position = cam.transform.position + new Vector3(0.05f, -12.07f, 5.46f);
                        item.transform.rotation = Quaternion.Euler(0f, -192.287f, 0f);
                        item.transform.localScale = new Vector3(10.32097f, 10.32097f, 10.32097f);
                    }
                    break;
                case Item.ItemType.Shoe:
                    {
                        item.transform.position = cam.transform.position + new Vector3(0.07f, -0.91f, 5.07f);
                        item.transform.rotation = Quaternion.Euler(20.996f, -143.991f, 10.379f);
                        item.transform.localScale = new Vector3(22.13272f, 22.13272f, 22.13272f);
                    }
                    break;
                case Item.ItemType.Tshirt:
                    {
                        item.transform.position = cam.transform.position + new Vector3(-0.4299114f, -11.62f, 2.99f);
                        item.transform.rotation = Quaternion.Euler(0f, 211.632f, 0f);
                        item.transform.localScale = new Vector3(16.42262f, 16.42262f, 16.42262f);
                    }
                    break;
                case Item.ItemType.Pants:
                    {
                        item.transform.position = cam.transform.position + new Vector3(-0.27f, -5.53f, 4.88f);
                        item.transform.rotation = Quaternion.Euler(0f, 32.571f, 0f);
                        item.transform.localScale = new Vector3(16.65366f, 16.65366f, 16.65366f);
                    }
                    break;
            }
            Debug.Log("set item scale :" + item.transform.localScale);
        }
        //Custom end
